...
By default the operator is installed directly via https://raw.githubusercontent.com/keycloak/keycloak-k8s-resources/refs/tags/26.0.2/kubernetes/kubernetes.yml[`keycloak-k8s-resources`].
